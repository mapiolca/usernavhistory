...
if (file_exists(DOL_DOCUMENT_ROOT.'/core/class/commonhookactions.class.php')) {
	...
	/**
	 * Compatibility parent using the native Dolibarr implementation.
	 */
	...
	/**
	 * Minimal compatibility parent for Dolibarr versions without CommonHookActions.
	 */
	abstract class RetroCompatCommonHookActions
	{
		/**
		 * @var string|null String displayed by executeHooks().
		 */
		public $resprints;
